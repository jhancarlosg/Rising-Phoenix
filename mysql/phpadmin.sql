...
SET
    ...
    -- -----------------------------------------------------
DROP
    DATABASE IF EXISTS `RegistroDB`;
    -- -----------------------------------------------------
    -- Schema RegistroDB
    -- -----------------------------------------------------
CREATE DATABASE IF NOT EXISTS `RegistroDB` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci; SHOW WARNINGS
    ;
USE
    `RegistroDB`;
    -- -----------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `RegistroDB`.`Cliente`(
    ...
    CONSTRAINT `fk_Cliente_Distrito1` FOREIGN KEY(`idDistrito`) REFERENCES `RegistroDB`.`Distrito`(`idDistrito`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE = InnoDB; SHOW WARNINGS
    ;
    -- -----------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `RegistroDB`.`Atencion`(
    ...
    CONSTRAINT `fk_Atencion_Cliente` FOREIGN KEY(`DNI`) REFERENCES `RegistroDB`.`Cliente`(`DNI`) ON DELETE NO ACTION ON UPDATE NO ACTION,
    CONSTRAINT `fk_Atencion_AsesorVentas1` FOREIGN KEY(`idAsesorVentas`) REFERENCES `RegistroDB`.`AsesorVentas`(`idAsesorVentas`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE = InnoDB; SHOW WARNINGS
    ;
    -- -----------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `RegistroDB`.`UsuarioAsesores`(
    ...
    CONSTRAINT `fk_AsesorVentas_has_Usuario_AsesorVentas1` FOREIGN KEY(`idAsesorVentas`) REFERENCES `RegistroDB`.`AsesorVentas`(`idAsesorVentas`) ON DELETE NO ACTION ON UPDATE NO ACTION,
    CONSTRAINT `fk_AsesorVentas_has_Usuario_Usuario1` FOREIGN KEY(`idUsuario`) REFERENCES `RegistroDB`.`Usuario`(`idUsuario`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE = InnoDB; SHOW WARNINGS
    ;
    -- -----------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `RegistroDB`.`Sesion`(
    ...
    CONSTRAINT `fk_Sesion_Usuario1` FOREIGN KEY(`idUsuario`) REFERENCES `RegistroDB`.`Usuario`(`idUsuario`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE = InnoDB; SHOW WARNINGS
    ;
USE
    `RegistroDB`;
    ...
    -- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `RegistroDB`.`Datos`(`id` INT); SHOW WARNINGS
    ;
    -- -----------------------------------------------------
...
USE
    `RegistroDB`;
CREATE OR REPLACE VIEW `Datos` AS WITH LISTA AS(
    SELECT
        A.fechaHora,
        C.*,
        AV.nombreCompleto AS asesor
    FROM
        Atencion A,
        Cliente C,
        AsesorVentas AV
    WHERE
        A.idAsesorVentas = AV.idAsesorVentas AND A.DNI = C.DNI
    UNION
SELECT
    A.fechaHora,
    C.*,
...
FROM
    ...
    Cliente C
WHERE
    A.DNI = C.DNI AND A.idAsesorVentas IS NULL
)
SELECT
    *
FROM
...
USE
    `RegistroDB`;
INSERT INTO `RegistroDB`.`Cliente`(
    `DNI`,
    `nombreCompleto`,
    `telefono`,
    `idDistrito`
...
USE
    `RegistroDB`;
INSERT INTO `RegistroDB`.`AsesorVentas`(`idAsesorVentas`, `nombreCompleto`)
VALUES(DEFAULT, 'DELIA PEREZ');
INSERT INTO `RegistroDB`.`AsesorVentas`(`idAsesorVentas`, `nombreCompleto`)
VALUES(DEFAULT, 'GUSTAVO MANYARI');
INSERT INTO `RegistroDB`.`AsesorVentas`(`idAsesorVentas`, `nombreCompleto`)
VALUES(DEFAULT, 'LESLIE ESPINOZA');
INSERT INTO `RegistroDB`.`AsesorVentas`(`idAsesorVentas`, `nombreCompleto`)
VALUES(DEFAULT, 'CAJA');
INSERT INTO `RegistroDB`.`AsesorVentas`(`idAsesorVentas`, `nombreCompleto`)
VALUES(DEFAULT, 'SAE');
...
USE
    `RegistroDB`;
INSERT INTO `RegistroDB`.`Atencion`(
    `idAtencion`,
    `fechaHora`,
    `DNI`,
    `idAsesorVentas`
